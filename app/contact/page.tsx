  ...
  <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-blue-400/10 via-blue-500/5 to-blue-600/10 dark:from-blue-900/30 dark:via-blue-900/20 dark:to-blue-900/30'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto w-full'>
          ...
          <div className='mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2 sm:px-0'>
            <a
              href='mailto:support@spendiq.com.pk'
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-10 sm:mb-12 md:mb-16'>
            ...
            <p className='text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto px-2 sm:px-0'>
              Hamari SpendIQ Pakistan support team se rabta karne ka tareeqa chunein 
              (Choose the most convenient way to reach out to our SpendIQ Pakistan support team).
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1 text-center'>
              <div className='absolute inset-0 bg-gradient-to-br from-blue-400/5 to-blue-400/5 rounded-xl sm:rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
              <div className='relative z-10'>
                <div className='w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg mb-4 sm:mb-6 mx-auto'>
                ...
                <a
                  href='mailto:support@spendiq.com'
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1 text-center sm:col-span-2 lg:col-span-1'>
              ...
              <div className='relative z-10'>
                ...
                <div className='text-blue-600 dark:text-blue-400 font-medium text-sm sm:text-base'>
                  Office #4, 2nd Floor, Centaurus Mall
                  <br />
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8'>
            <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-gray-100/50 dark:border-gray-700/50'>
              <div className='flex items-center gap-3 mb-4'>
                <div className='w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-md sm:rounded-lg flex items-center justify-center shadow-lg'>
              ...
              <div className='space-y-2 text-sm sm:text-base text-gray-600 dark:text-gray-400'>
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium'>9:00 AM - 5:00 PM PKT</span>
                </div>
                <div className='flex justify-between'>
                  <span>Saturday:</span>
                  <span className='font-medium'>10:00 AM - 2:00 PM PKT</span>
                </div>
                <div className='flex justify-between'>
                  <span>Friday:</span>
                  <span className='font-medium'>9:00 AM - 1:00 PM PKT</span>
                </div>
                <div className='flex justify-between'>
                  <span>Sunday:</span>
